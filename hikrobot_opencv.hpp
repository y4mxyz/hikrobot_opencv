#ifndef __HIKROBOT_CV_HPP
#define __HIKROBOT_CV_HPP
...
class OpencvCamera final {
    ...
    friend class MvContext; // friend class and private constructor
    ...
    public:
        ...
        cv::Mat ref_cv_mat(unsigned timeout_msec=HIKROBOT_CV_TIMEOUT_MSEC) {
            ...
            int cv_pixel_type;
            if(cv_pixel_type&MV_GVSP_PIX_CUSTOM) throw std::runtime_error("unsupport pixel type");
            ...
            switch(pixel_type&MV_GVSP_PIX_COLOR_MASK) {
                ...
                default: throw std::runtime_error("unsupport pixel type");
            }
...
class MvContext final {
    ...
    private:
        ...
        MvContext(void) { // private constructor for singleton context
